...
const FAQ = () => {
  ...
  return (
    <Container>
      ...
      <Row className="mt-4">
        <Col>
          <h4 className="bold mt-5">Qu’est-ce que le Jugement Majoritaire ?</h4>
          <p>
            Un principe simple et intuitif, qui change tout : l’électeur vote en
          ...
          <p>
            ...
            plus d’informations que dans le cadre du scrutin uninominal qui,
            résumant l’opinion des électeurs à un choix, ignore l’essentiel de
            l’information quant à ce qu’ils pensent. En agrégeant un grand
            nombre d’informations, le Jugement Majoritaire ne produit pas «
            ...
            d’affiner autant que de pacifier la prise de décision.
          </p>
          ...
          <p>
            ...
            . Dans le cas d’un vote sur invitation nous vous suggérons de ne pas
